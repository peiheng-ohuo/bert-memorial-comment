...
parser.add_argument('--raw_data', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor.xlsx')
parser.add_argument('--pkl_data', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor.pkl')
parser.add_argument('--train_dataset', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor_train.pt')
parser.add_argument('--valid_dataset', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor_valid.pt')
parser.add_argument('--test_dataset', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor_test.pt')
parser.add_argument('--infer_file', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor_test_infer.xlsx')
parser.add_argument('--memorial_data', type=str, default='data/both_delegate_allemperor/both_allemperor.xlsx')
parser.add_argument('--full_dataset', type=str, default='data/both_delegate_allemperor/both_allemperor.pt')
parser.add_argument('--output_dataset', type=str, default='data/both_delegate_allemperor/both_delegate_allemperor_predict.xlsx')
...
parser.add_argument('--save_autobest_checkpoint', type=str, default='checkpoints/both_delegate_allemperor_12.22_autobest.pt')
parser.add_argument('--save_epoch_checkpoint', type=str, default='checkpoints/both_delegate_allemperor_12.22_epoch{}.pt')
parser.add_argument('--best_model', type=str, default='best_model/both_delegate_allemperor_12.22_epoch3.pt')
...
def infer_test_dataset():
    ...
    df = pd.DataFrame({
        ...
        'delegate': true_labels,
        'predict_delegate': pred_labels.flatten()
    })
